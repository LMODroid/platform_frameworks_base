    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
                    ...
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    LMOSettings.System.VOLUME_UP_AND_DOWN_MUTE), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
    ...
    void updateSettings(Handler handler) {
        ...
        synchronized (mLock) {
            ...
            mVolUpAndDownMute = Settings.System.getIntForUser(resolver,
                    LMOSettings.System.VOLUME_UP_AND_DOWN_MUTE, 0,
                    UserHandle.USER_CURRENT) == 1;
        ...
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_ESCAPE:
                if (firstDown && event.isMetaPressed()) {
                    ...
                    injectBackGesture(event.getDownTime(), getTargetDisplayIdForKeyEvent(event));
                    return true;
                }
                break;
