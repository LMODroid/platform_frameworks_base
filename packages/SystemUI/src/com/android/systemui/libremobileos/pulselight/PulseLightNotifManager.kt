...
class PulseLightNotifManager @Inject constructor(
    ...
    companion object {
        private const val PULSE_AMBIENT_LIGHT = LMOSettings.Secure.PULSE_AMBIENT_LIGHT
        private const val PULSE_AMBIENT_LIGHT_DURATION =
                LMOSettings.Secure.PULSE_AMBIENT_LIGHT_DURATION
        private const val PULSE_AMBIENT_LIGHT_REPEAT_COUNT =
                LMOSettings.Secure.PULSE_AMBIENT_LIGHT_REPEAT_COUNT
    }
