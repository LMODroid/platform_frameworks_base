    ...
    private void handleStartKeyguardExitAnimationInner(long startTime, long fadeoutDuration,
        ...
        if (!KeyguardWmStateRefactor.isEnabled() && error != null) {
            ...
            if (mLockPatternUtils.isSecure(currentUserId)) {
                ...
                mKeyguardInteractor.showKeyguard();
                mShadeController.get().instantCollapseShade();
                setShowingLocked(true /* showing */, true /* force */, "handleStartKeyguardExitAnimation - secure");
            } else {
                resetStateLocked();
                dismiss(null, null);
            }
        ...
        postAfterTraversal(() -> {
            ...
            if (mIsKeyguardExitAnimationCanceled) {
                Log.d(TAG, "Ignoring exitKeyguardAndFinishSurfaceBehindRemoteAnimation. "
                        + "mIsKeyguardExitAnimationCanceled==true");
                finishSurfaceBehindRemoteAnimation(true /* showKeyguard */);
                setShowingLocked(true /* showing */, true /* force */, "exitKeyguardAndFinishSurfaceBehindRemoteAnimation - canceled");
                return;
            }
