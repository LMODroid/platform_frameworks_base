...
interface PaginatableGridViewModel {
     ...
     *
     * It will leave gaps at the end of a row if the next [SizedTile] has [SizedTile.width] that is
     * larger than the space remaining in the row.
     */
    fun splitInRows(
    ...
    interface Factory {
        fun create(): PaginatableGridViewModel
    }
}
